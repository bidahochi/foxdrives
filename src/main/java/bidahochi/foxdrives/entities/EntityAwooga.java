...
import bidahochi.foxdrives.models.Modelawooga;
import fdfexcraft.tmt_slim.ModelBase;
import net.minecraft.world.World;


public class EntityAwooga extends EntityCarChest
{

    public EntityAwooga(World world) {
        super(world);
    }
    ...
    public String[] getSkins() {
        return new String[]{"textures/awoogacar_white", "textures/awoogacar_black"};
    }

    @Override
    public CarType type(){
        return CarType.AWOOGA;
    }
