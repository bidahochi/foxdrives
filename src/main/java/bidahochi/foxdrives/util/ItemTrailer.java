...
public class ItemTrailer extends Item {
    /**the class for the entity*/
    private final TrailerType transport;


    /**the main constructor.
     * @param trailer the class for the entity*/
    public ItemTrailer(TrailerType trailer, String MODID, CreativeTabs tabs) {
        super();
        transport=trailer;
    ...
    public boolean onItemUse(ItemStack itemStack, EntityPlayer playerEntity, World worldObj, int posX, int posY, int posZ, int blockSide, float pointToRayX, float pointToRayY, float pointToRayZ) {
        ...
        try
        {
            EntityTrailer ent = transport.clazz.getConstructor(World.class)
    ...
    public static ItemStack setPersistentData(@Nullable ItemStack oldStack, @Nullable EntityTrailer car)
    {
