...
public class FoxDrives {
    ...
    public void init(FMLInitializationEvent event)
    {
        ...
        CarType.DOSEI_KIOTE_SEDAN = CarType.register("dosei_kiote_sedan", EntityDoseiKiote_Sedan.class)
                ...
                .maxspeed(3.5f, 0.25f)// 1.5
                .inventorySize(InventorySize.STYLE_PROFILE_3x3)// speed 3 is approx 100 kmh tc speed
                .year("1986");
